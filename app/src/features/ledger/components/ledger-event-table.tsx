...
export function LedgerEventTable({ events, onRowClick }: Props) {
  ...
  return (
    <table className="w-full table-fixed border-collapse text-xs">
      <thead>
        <tr className="border-b border-zinc-800 text-left text-3xs uppercase tracking-wider text-zinc-500">
      ...
      <tbody>
        {events.map((e, i) => (
          ...
          >
            <td className="p-2 font-mono text-3xs uppercase">
            ...
            <td className="truncate p-2 font-mono text-3xs text-blue-400">
