...
export function LedgerCidLink({ cid, prefixLabel, truncate = 8, className }: LedgerCidLinkProps) {
  ...
  return (
    <Link
      ...
      className={
        className ??
        'inline-flex items-center gap-1 rounded border border-zinc-700 bg-zinc-900 px-1.5 py-0.5 font-mono text-3xs text-blue-400 hover:border-zinc-600 hover:bg-zinc-800'
      }
    >
